...
const modifier = (text) => {
  ...
  try {
    ...
    function detectSentiment(text) {  // Definition for sentiment detection
    ...
    if (sentiment !== 'neutral') {  // Added: Reset sceneTurnCounter on positive/negative, mirroring linger logic for extended scenes
    ...
    // Commented out for diagnostic testing: if (state.sceneTurnCounter > 3) {
    //   advancePeriod();
