...
function AutoCards(inHook, inText, inStop) {
    "use strict";
    const DEFAULT_DO_AC = true; // Enabled by default for romance tracking
    const DEFAULT_PIN_CONFIGURE_CARD = true;
    const DEFAULT_CARD_CREATION_COOLDOWN = 30; // Higher for slower pacing, less processing per turn
